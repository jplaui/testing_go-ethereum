...
func main() {
	...
	fmt.Println("block header number:", header.Number.String()) // 5671744
	...
	fmt.Println("block.NumberU64:", block.NumberU64())                 // 5671744
	fmt.Println("block.Time:", block.Time())                           // 1527211625
	fmt.Println("block.Difficulty:", block.Difficulty())               // 3217000136609065
	...
	fmt.Println("transaction count:", count) // 144
}
